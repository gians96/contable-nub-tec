...
- **Qué pagar cada mes:** en `/resumen-mensual`, *Resultado IGV* (casilla 184) enseña el impuesto o el saldo a favor que se arrastra, y *Pagar IGV* / *Pagar IR* lo que sale del bolsillo (IGV en 0 cuando el saldo a favor lo cubre); junto a *Pagado IGV* / *Pagado IR* se compara con lo registrado. Si SUNAT no precarga la casilla 145, hay que escribir el saldo a favor del mes anterior: con 0, el formulario cobra IGV que ese saldo ya cubría. Las columnas ocultas y el modo de decimales se recuerdan entre recargas.
